...
enum Message_MessageType {
  ...
  Message_MessageType_CHALLENGE = 4,
  Message_MessageType_LOGIN_CALLBACK = 5
};
bool Message_MessageType_IsValid(int value);
const Message_MessageType Message_MessageType_MessageType_MIN = Message_MessageType_CONNECT;
const Message_MessageType Message_MessageType_MessageType_MAX = Message_MessageType_LOGIN_CALLBACK;
...
class Message : public ::google::protobuf::Message {
 public:
  ...
  static const MessageType LOGIN_CALLBACK = Message_MessageType_LOGIN_CALLBACK;
